...
public class HotelPage<Webdriver> extends ElementUtil {
    ...
    private By fourStars = By.id("f-label-star-rating-4");
    ...
    public void setCityTextField(String setCity) throws InterruptedException {
      ...
      Thread.sleep(500);
        ...
        for (String string : splitString){
            reString += string.substring(0,1).toUpperCase() + string.substring(1).toLowerCase() + " ";
        ...
        for (WebElement city : cities){
            if (city.getText().contains(reString)){
                city.click();
                break;
            }
        }
...
//
    ...
    public void clickOnFiveStars(){
        //tolscrollByElement(fiveStars);
        clickOn(fiveStars);
    }
    public void clickOnFourStars(){
     //   scrollByElement(fourStars);
        clickOn(fourStars);
    }
    ...
    public void clickOnCityCenter() throws InterruptedException {
